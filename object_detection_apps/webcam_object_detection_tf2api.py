"""
Detect Objects Using Your Webcam with TensorFlow 2 Object Detection API
Using ssd mobilenet v2 320x320 pre trained model

This follows tensorflow 2 object detection api tutorial to test current setup on laptop
...
# Download and extract model. I will use ssd mobilenet for smoother running on webcam.
MODEL_DATE = '20200711'
...
PATH_TO_CONFIG = os.path.join(MODELS_DIR, os.path.join(MODEL_NAME, 'pipeline.config'))
